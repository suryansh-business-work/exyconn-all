...
const ChatWithPDF: React.FC = () => {
    ...
    try {
      ...
      reader.onload = async () => {
        ...
        const res = await fetch(APIs.chatTools.extractDocument, {
          ...
          body: JSON.stringify({ fileData: base64, mimeType: 'application/pdf', fileName: file.name }),
        });
  ...
  return (
    <ToolLayout toolName="Chat With PDF" toolIcon={<PictureAsPdf />} toolColor="#ef4444">
          ...
          <Grid size={{ xs: 12, md: 4 }}>
            ...
            <Paper elevation={0} sx={{ p: 2, mt: 2, border: 1, borderColor: 'divider', borderRadius: 2 }}>
              ...
              <Button
                ...
                sx={{ mb: 1 }}
              >
                {isLoadingContent ? 'Extracting...' : 'Choose PDF'}
