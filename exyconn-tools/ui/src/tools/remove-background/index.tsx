...
export default function RemoveBackground() {
  ...
  const download = () => {
    ...
    a.href = result;
    a.download = outputFileName(file.name);
    a.click();
  };
        ...
        <Grid container spacing={3}>
            ...
            {original && (
              <Paper sx={{ p: 2, mt: 2, textAlign: 'center' }}>
                ...
                <Box
                  ...
                  src={original}
                  alt="Original"
                  sx={{ maxWidth: '100%', maxHeight: 360, borderRadius: 1 }}
                />
              </Paper>
            )}
          </Grid>
          ...
          <Grid size={{ xs: 12, md: 6 }}>
            <Paper sx={{ p: 3 }}>
              ...
              >
                Processing happens on the Exyconn server — your image is uploaded for background removal and is never
                stored or shared.
              </Typography>
            </Paper>
              ...
              <Paper sx={{ p: 2, mt: 2, textAlign: 'center' }}>
                ...
                <Box sx={{ ...CHECKERBOARD, display: 'inline-block', borderRadius: 1, p: 1 }}>
                  <Box
                    ...
                    sx={{ maxWidth: '100%', maxHeight: 360, display: 'block' }}
                  />
                </Box>
                <Button
                  variant="outlined"
