...
import { ACCEPTED_TYPES, canvasToPngBlob, downloadBlob, drawMeme, loadImage, memeFileName } from './utils';
...
export default function MemeGenerator() {
  ...
  const loadFile = useCallback(async (f: File) => {
    if (!ACCEPTED_TYPES.has(f.type)) {
      setError('Please select a JPG, PNG, WEBP, GIF, or BMP image.');
      return;
    }
    try {
        ...
        <Grid container spacing={3}>
          ...
          <Grid size={{ xs: 12, md: 5 }}>
            <Paper sx={{ p: 3 }}>
              ...
              <Typography variant="subtitle2" id="top-padding-slider-label">
              ...
              <Slider
                ...
                sx={{ color: COLOR, mb: 1 }}
              />
              <Typography variant="subtitle2" id="bottom-padding-slider-label">
