        ...
        <Grid container spacing={3}>
          <Grid size={{ xs: 12, md: 4 }}>
            <DomainInputForm
              ...
              isLoading={isLoading}
              icon={<GppBad color="primary" />}
              title="Blacklist Check"
              buttonText="Check Blacklists"
              loadingText="Checking blacklists..."
            />
          </Grid>
          <Grid size={{ xs: 12, md: 8 }}>
            {result && (
              <DomainResultDisplay
                title={`Blacklist Results - ${result.domain}`}
              ...
              >
                <Box sx={{ textAlign: 'center', py: 2, mb: 2 }}>
                  ...
                  <Chip
                    label={`${result.listedCount}/${result.totalChecked} blacklists`}
                    color={result.isClean ? 'success' : 'error'}
                    sx={{ mt: 1 }}
                  />
                  <Typography
                    variant="body2"
