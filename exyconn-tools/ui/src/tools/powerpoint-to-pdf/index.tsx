...
export default function PowerpointToPdf() {
  ...
  const loadFile = useCallback((f: File) => {
    if (!isAcceptedFile(f.name)) { setFileError('Please select a PowerPoint file (.ppt or .pptx).'); return; }
  ...
  return (
    <ToolLayout toolName="PowerPoint to PDF" toolIcon={<FaFilePowerpoint />} toolColor={COLOR}>
            ...
            >
              ...
              <Typography
                ...
                sx={{
                  ...
                  mb: 1
                }}>Supports .ppt and .pptx files</Typography>
            ...
            {file ? (
              ...
              <Paper sx={{ p: 3 }}>
                <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', py: 4 }}>
                  <Box sx={{ fontSize: 64, color: 'text.disabled', mb: 2, display: 'flex' }}><FaFilePowerpoint /></Box>
                  <Typography sx={{
                    color: "text.secondary"
                  }}>Upload a PowerPoint presentation to get started</Typography>
                </Box>
              </Paper>
            )}
          </Grid>
