          ...
          <Grid size={{ xs: 12, md: 5 }}>
            <Paper sx={{ p: 3, borderRadius: 2 }}>
              ...
              <TextField
                ...
                size="small"
                label="Business Name"
                placeholder="Exyconn Technologies"
                value={businessName}
              ...
              <TextField
                fullWidth
                size="small"
                label="Unique Points (comma-separated)"
                placeholder="Award-winning, 10+ years experience"
                value={uniquePoints}
                  ...
                  <Paper key={desc.variant} sx={{ p: 3, borderRadius: 2 }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 1 }}>
                      ...
                      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                        <Chip
                          size="small"
                          label={`${desc.length}/750 chars`}
                          color={desc.isWithinLimit ? 'success' : 'error'}
                          variant="outlined"
                        />
                        <Button
                          size="small"
                    ...
                    <Typography
                      variant="body2"
                      sx={{ lineHeight: 1.7, bgcolor: 'action.hover', p: 2, borderRadius: 1 }}
                    >
                      {desc.text}
                    </Typography>
                  </Paper>
