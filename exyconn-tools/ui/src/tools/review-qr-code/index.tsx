...
import { Container, Box, Typography, TextField, Button, Paper, Chip, Slider, Snackbar, Alert } from '@mui/material';
...
const ReviewQRCode: React.FC = () => {
  ...
  useEffect(() => {
    ...
    renderQrToCanvas(canvasRef.current, generatedLink, { size, fgColor, bgColor }).catch(() =>
            ...
            {generatedLink && (
              <Paper sx={{ p: 3, borderRadius: 2, textAlign: 'center' }}>
                ...
                <Box sx={{ mb: 2 }}>
                  <canvas
                    ref={canvasRef}
                    aria-label="Review QR code preview"
