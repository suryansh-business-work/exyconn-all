        ...
        <Grid container spacing={3}>
          <Grid size={{ xs: 12, md: 6 }}>
            <Paper
              sx={{
                ...
                textAlign: 'center',
                border: '2px dashed',
                borderColor: dragOver ? '#22c55e' : 'divider',
                cursor: 'pointer',
                transition: '0.2s',
              }}
            ...
            <Box sx={{ mt: 2, display: 'flex', flexDirection: 'column', gap: 2 }}>
              ...
              />
              <TextField
                label="Owner Password (to edit, optional)"
                type="password"
                fullWidth
                size="small"
                value={ownerPassword}
          ...
          <Grid size={{ xs: 12, md: 6 }}>
            <Alert severity="info" icon={<Info />} sx={{ mb: 2 }}>
              Your PDF is encrypted on our server with <strong>AES-256</strong> and the passwords you set. Files are
            ...
            <Button
              variant="contained"
              fullWidth
              sx={{ bgcolor: '#22c55e', mb: 2, '&:hover': { bgcolor: '#16a34a' } }}
              onClick={protect}
