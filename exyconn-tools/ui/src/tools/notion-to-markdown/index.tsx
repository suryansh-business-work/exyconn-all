...
const NotionToMarkdown: React.FC = () => {
  ...
  const handleDownload = () => {
    ...
    a.href = u;
    a.download = `${title.replace(/[^a-z0-9]/gi, '-').toLowerCase() || 'notion-page'}.md`;
    a.click();
  };

  return (
    <ToolLayout toolName="Notion to Markdown" toolIcon={<Bookmark />} toolColor="#000000">
