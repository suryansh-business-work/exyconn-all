...
import { Paper, Box, Typography, TextField, Button, CircularProgress, LinearProgress } from '@mui/material';
...
const ValidatorForm: React.FC<ValidatorFormProps> = ({ sitemapUrl, isLoading, onUrlChange, onValidate }) => (
