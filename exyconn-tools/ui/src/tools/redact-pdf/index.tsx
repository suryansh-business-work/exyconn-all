          ...
          <Grid size={{ xs: 12, md: 5 }}>
            ...
            {file && (
              <Paper sx={{ p: 2, mt: 2 }}>
                ...
                >
                  {fmt(file.size)} · {pageCount} page(s)
                </Typography>
              </Paper>
            )}
          ...
          <Grid size={{ xs: 12, md: 7 }}>
            <Paper sx={{ p: 3 }}>
              ...
              <Alert severity="info" sx={{ mb: 2 }}>
                Redaction draws black rectangles over content. For complete content removal, reprocess with a
                professional tool.
              </Alert>
              <Grid container spacing={1} sx={{ mb: 2 }}>
                ...
                <Grid size={{ xs: 4, sm: 2 }} sx={{ display: 'flex', alignItems: 'center' }}>
                  <Button
                    ...
                    disabled={!file}
                    sx={{ bgcolor: COLOR, '&:hover': { bgcolor: '#dc2626' } }}
                  >
                    Add
                  </Button>
                </Grid>
              ...
              <Button
                ...
                disabled={!file || redactions.length === 0 || processing}
