          ...
          <Grid size={{ xs: 12, md: 5 }}>
            <Paper sx={{ p: 3 }}>
              ...
              <Alert severity="info" sx={{ mt: 2 }}>
                Analyzes your website&apos;s content structure and SEO factors that influence visibility in AI search
          ...
          <Grid size={{ xs: 12, md: 7 }}>
                ...
                <Paper sx={{ p: 3 }}>
                  ...
                  <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 2, mb: 2 }}>
                    ...
                    <Paper variant="outlined" sx={{ p: 2, flex: '1 1 100px', textAlign: 'center' }}>
                      <Typography
                        variant="h5"
                        color={result.wordCount > 300 ? '#22c55e' : '#f59e0b'}
                        sx={{
                          fontWeight: 'bold',
                        }}
                      >
                    ...
                    <Paper variant="outlined" sx={{ p: 2, flex: '1 1 100px', textAlign: 'center' }}>
                      <Chip
                        label={result.hasStructuredData ? 'Yes' : 'No'}
                        color={result.hasStructuredData ? 'success' : 'error'}
                        size="small"
                      />
                      <Typography
                        variant="caption"
            ...
            {!result && !isLoading && (
              <Paper sx={{ p: 4, textAlign: 'center' }}>
                ...
                >
                  Enter your website URL to check AI search visibility
                </Typography>
              </Paper>
            )}
          </Grid>
