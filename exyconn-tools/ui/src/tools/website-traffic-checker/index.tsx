        ...
        <Grid container spacing={3}>
          <Grid size={{ xs: 12, md: 4 }}>
            <Paper sx={{ p: 3 }}>
              ...
              >
                <Search sx={{ mr: 0.5, verticalAlign: 'middle', fontSize: 18 }} />
                Analyze Website
              </Typography>
              <TextField
                fullWidth
              ...
              <Alert severity="info" sx={{ mt: 2, fontSize: '0.75rem' }}>
                Analyzes real page performance, content structure, technology stack, social presence, and link profile.
              </Alert>
            </Paper>
          </Grid>
          <Grid size={{ xs: 12, md: 8 }}>
            {result ? (
                ...
                <Paper sx={{ p: 3 }}>
                  ...
                  {result.content.title && (
                    <Typography variant="body2" sx={{ mb: 0.5 }}>
                      <b>Title:</b> {result.content.title}
                    </Typography>
                  )}
                  ...
                  <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1, mt: 1 }}>
                    ...
                    <Chip
                      label={`External Domains: ${result.content.externalDomains}`}
                      size="small"
                      variant="outlined"
                    />
                  </Box>
              ...
              <Paper sx={{ p: 4, textAlign: 'center' }}>
                ...
                >
                  Enter a URL to analyze website performance and technology stack
                </Typography>
              </Paper>
            )}
          </Grid>
