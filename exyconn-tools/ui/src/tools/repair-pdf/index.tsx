          ...
          <Grid size={{ xs: 12, md: 6 }}>
            <Paper sx={{ p: 3 }}>
              ...
              <Alert severity="info" sx={{ mb: 2 }}>
                Re-serializing a PDF can fix minor structural corruption by rebuilding the file's object table.
              </Alert>
              ...
              <Button
                ...
                sx={{ bgcolor: COLOR, '&:hover': { bgcolor: '#d97706' }, mb: 2 }}
              >
              ...
              {status === 'success' && (
                <Box>
                  <Chip
                    icon={<CheckCircle />}
                    label="PDF loaded successfully — re-serialized for integrity"
                    color="success"
                    sx={{ mb: 2, width: '100%' }}
                  />
              ...
              {status === 'failed' && (
                <Box>
                  <Chip
                    icon={<ErrorOutline />}
                    label="Failed to load — PDF may be severely corrupted"
                    color="error"
                    sx={{ mb: 2, width: '100%' }}
                  />
