        ...
        <Grid container spacing={3}>
          <Grid size={{ xs: 12, md: 4 }}>
            <DomainInputForm
              ...
              isLoading={isLoading}
              icon={<DomainVerification color="primary" />}
          ...
          <Grid size={{ xs: 12, md: 8 }}>
            {result && (
              <DomainResultDisplay
                title={`${result.domain}`}
                icon={<DomainVerification fontSize="small" />}
                data={result}
              >
                <Box sx={{ textAlign: 'center', py: 4 }}>
                  ...
                  <Chip label={result.message as string} size="medium" color={result.available ? 'success' : 'info'} />
