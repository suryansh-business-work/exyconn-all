...
import { Box, List, ListItemButton, ListItemIcon, ListItemText, Typography, Chip, Paper } from '@mui/material';
...
const CategorySidebar: React.FC<Readonly<CategorySelectProps>> = ({ selectedCategory, onCategoryChange }) => {
