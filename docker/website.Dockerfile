...
# needed here, never at runtime. Its tsconfig extends @exyconn/config's, which esbuild
# resolves while transforming it — without config the build fails before emitting a page.
