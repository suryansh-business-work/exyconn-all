...
// Importing for the side effect: the module that owns invoices registers what it wants
// chased, so the reminder sweep never has to know finance exists.
import './finance.reminders';
