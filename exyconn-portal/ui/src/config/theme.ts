...
export function createAppTheme(mode: ColorMode): Theme {
  ...
  return createTheme({
    ...
    components: {
      ...
      MuiMenu: { styleOverrides: { paper: { border: `1px solid ${t.divider}`, boxShadow: t.shadowMd } } },
      MuiPopover: { styleOverrides: { paper: { border: `1px solid ${t.divider}`, boxShadow: t.shadowMd } } },
