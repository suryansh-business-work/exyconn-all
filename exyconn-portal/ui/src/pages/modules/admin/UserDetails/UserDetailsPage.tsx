...
export function UserDetailsPage() {
  ...
  // Reachable from both Admin (/portal/admin/users/:id) and HR (/portal/hr/employees/:id).
  const fromHr = pathname.startsWith('/portal/hr');
  const backTo = fromHr ? '/portal/hr/employees' : '/portal/admin';
