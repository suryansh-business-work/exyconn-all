/**
 * The portal refused this device: the token is missing, or the device or its access grant has
 * been revoked. The app stops tracking and signs itself out, carrying the reason with it.
 */
 ...
 *
 * The status is read back out of the message because that is where the portal client puts it —
