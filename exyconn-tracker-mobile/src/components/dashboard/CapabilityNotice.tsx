...
export function CapabilityNotice() {
  ...
  return (
    <Notice
      ...
      detail={t(
        'Apple lets no app see screenshots, other apps, or your typing and taps, and it stops apps that are not on screen. Keep the tracker open while you work, and claim anything else as off-computer time.',
      )}
    >
      {t('iPhone records your time only while the tracker is open.')}
    </Notice>
  );
}
